...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        list=list+[rg.Rectangle(rg.Point(circles[k].center.x-circles[k].radius,circles[k].center.y-circles[k].radius),rg.Point(circles[k].center.x+circles[k].radius,circles[k].center.y+circles[k].radius))]
    return list
